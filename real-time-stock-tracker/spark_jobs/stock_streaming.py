...
category_agg = events_df.groupBy(
    ...
    sum("delta").alias("category_total_delta")
)
...
# Kritik stok alarmı: new_stock < 10 olan ürünler için alert stream
...
while query.isActive and category_query.isActive and alert_query.isActive:
    time.sleep(1)
